...
function buildBannerStyles() {
  return `#cookie-consent-banner{position:fixed;left:50%;bottom:24px;transform:translateX(-50%);width:520px;max-width:calc(100vw - 32px);background:rgba(255,255,255,.9);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid #e7e7e7;border-radius:12px;padding:16px 20px;box-shadow:0 16px 40px rgba(0,0,0,.14);z-index:99999;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;animation:cookieFade .35s ease}.cookie-header{display:flex;align-items:center;gap:8px;margin-bottom:8px}.cookie-header h3{margin:0;color:#000;font-size:.95rem;font-weight:700;line-height:1.1}.cookie-text{margin:0;color:#4f4f4f;font-size:13px;line-height:1.6}.cookie-buttons{display:flex;flex-wrap:wrap;align-items:center;gap:8px 14px;margin-top:14px}.cookie-buttons button{flex:1 1 0;min-width:120px;height:36px;border-radius:6px;font:inherit;font-size:13px;font-weight:600;cursor:pointer;transition:all .2s ease}.cookie-accept{background:#000;color:#fff;border:none}.cookie-accept:hover{background:#222}.cookie-decline{background:#fff;color:#000;border:1.5px solid #000}.cookie-decline:hover{background:#f6f6f6}.cookie-privacy{flex:0 0 auto;color:#4f4f4f;text-decoration:none;font-size:12px;font-weight:600;white-space:nowrap}.cookie-privacy:hover{color:#000;text-decoration:underline}#cookie-consent-banner[data-theme="dark"]{background:rgba(26,26,26,.9);border-color:#2e2e2e;box-shadow:0 16px 40px rgba(0,0,0,.4)}#cookie-consent-banner[data-theme="dark"] .cookie-header h3{color:#fff}#cookie-consent-banner[data-theme="dark"] .cookie-text{color:#bdbdbd}#cookie-consent-banner[data-theme="dark"] .cookie-accept{background:#fff;color:#000}#cookie-consent-banner[data-theme="dark"] .cookie-accept:hover{background:#e2e2e2}#cookie-consent-banner[data-theme="dark"] .cookie-decline{background:transparent;color:#fff;border-color:#fff}#cookie-consent-banner[data-theme="dark"] .cookie-decline:hover{background:#2a2a2a}#cookie-consent-banner[data-theme="dark"] .cookie-privacy{color:#bdbdbd}#cookie-consent-banner[data-theme="dark"] .cookie-privacy:hover{color:#fff}@keyframes cookieFade{from{opacity:0;transform:translateX(-50%) translateY(16px)}to{opacity:1;transform:translateX(-50%) translateY(0)}}@keyframes cookieFadeMobile{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}}@media(max-width:480px){#cookie-consent-banner{left:16px;right:16px;bottom:16px;width:auto;transform:none;padding:14px 16px;animation:cookieFadeMobile .35s ease}.cookie-buttons button{flex:1 1 100%}.cookie-privacy{flex:1 1 100%;text-align:center}}`;
}
